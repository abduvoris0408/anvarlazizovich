    ...
    <section className="relative overflow-hidden min-h-[40vh] flex items-center bg-background border-b border-border pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 relative z-20 w-full mt-10 sm:mt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Qonunchilik va huquq sohasidagi muhim o'zgarishlar haqida <br className="hidden sm:block" />
            <span className="text-foreground font-medium">foydali ma'lumotlar, yangiliklar va maqolalar.</span>
          </motion.p>
        </div>
      </div>
    </section>
