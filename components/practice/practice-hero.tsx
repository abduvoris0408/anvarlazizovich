    ...
    <section className="relative overflow-hidden min-h-[40vh] flex items-center bg-background border-b border-border pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 relative z-20 w-full mt-10 sm:mt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="text-foreground drop-shadow-sm">Huquqiy </span>
          ...
          >
            Keng ko'lamli huquqiy masalalarda professional yordam va maslahatlar. <br className="hidden sm:block" />
            <span className="text-foreground font-medium">Sizning huquqlaringizni himoya qilish bizning asosiy vazifamiz.</span>
          </motion.p>
        </div>
      </div>
    </section>
